...
/** AVC/RVE algorithm. The maximum array size for this parameter is:
...
/** Multiband Dynamic Range Control (MBDRC_V2) algorithm. This Param id supports,
    calibration for upto 5 bands, sampling rate NB/WB/SWB/FB and
    higher order FIR filter for SWB and FB sampling rates.

    Payload structure:
    |----------------------------------------------------|
    | voice_mbdrc_v2_config_params_t                     |
    |----------------------------------------------------|
    | audproc_subband_drc_config_params_t x Num of bands |
    |----------------------------------------------------|
    | filterlength                                       |
    |----------------------------------------------------|
    | sFilterCoeff[filterlength]                         |
    |----------------------------------------------------|
    | sMuteFlags[Num of bands]                           |
    |----------------------------------------------------|

    @inputtable{Calibration_ID_VOICE_PARAM_MBDRC_V2.tex}
*/
#define VOICE_PARAM_MBDRC_V2                 (0x00010E66)

/** This is the new Param ID defined to monitor the MBDRC filter cross over
    frequencies for different sub bands.

    Payload Structure
    |----------------------------------------------------|
    | filter_xover_freqs [Num of bands - 1]              |
    |----------------------------------------------------|

    @inputtable{Calibration_ID_VOICE_PARAM_MBDRC_FILTER_XOVER_FREQ.tex}
*/
...
/** ID of the Single-mic ECNS_V2 parameter.

    The maximum array size for this parameter is:
    - Version 0 -- 96 bytes

    @inputtable{Calibration_ID_VOICE_PARAM_SMECNS_V2_NS.tex} @newpage
*/
...
/** ID of the Single-mic ECNS_V2 parameter.
    ...
    @inputtable{Calibration_ID_VOICE_PARAM_SMECNS_V2_EC.tex} @newpage
*/
...
/** ID of the read-only parameter structure for internal status monitoring of
    ...
    @inputtable{Calibration_ID_VOICE_PARAM_SMECNS_V2_EC_STATE.tex} @newpage
*/
...
/** ID of the read-only parameter structure for internal status monitoring of
    ...
    @inputtable{Calibration_ID_VOICE_PARAM_SMECNS_V2_NS_STATE.tex} @newpage
*/
...
/** ID of the parameter for Fixed Echo Path Delay in the firmware. The delay
    ...
    @inputtable{Calibration_ID_VOICE_PARAM_SMECNS_V2_EC_DELAY.tex}
*/
...
/** ID of the read-only parameter used to return the Adaptive Filter (AF)
  ...
  @keep{8} @subhead{AF data structure for the VPM\_TX\_DM\_FLUENCEV5\_BROADSIDE  topology}
    ...
    VPM_TX_SM_ECNS_V2, VPM_TX_QM_FLUENCE_PROV2, and VPM_TX_DM_FLUENCEV5_BROADSIDE
...
/** Module that identifies Single-mic ECNS_V2 in the voice processor on the
    Tx path.
...
/** Identifies the AVC/RVE algorithm that is part of voice postprocessing on
    the Tx path. This module is Tx counter part of VOICE_MODULE_RX_AVCRVE on Rx path.
    This module does not support calibration data. VPM will ensure VOICE_MODULE_RX_AVCRVE
    calibration is applied to this module as well.
...
/** Identifies the multiband Dynamic Range Control (MBDRC) algorithm in
    the voice processor on the Rx path. This module supports,
    calibration for up to 5 bands, sampling rate NB/WB/SWB/FB,
    higher order FIR filter for SWB and FB sampling rate.
    This module supports the following parameter IDs:
...
/** This module ID identifies the gain of Voice downlink path processing.
    This module supports the following parameter IDs:
