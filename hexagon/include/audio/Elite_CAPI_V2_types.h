...
#define CAPI_V2_ENOTREADY           (((uint32_t)1) << 5)
...
/** Maximum number of channels supported in a stream with version 2 modules */
...
/** Version 2 payload structure for FIXED_POINT, FLOATING_POINT, and
...
struct capi_v2_standard_data_format_v2_t
{
   ...
   /**< Channel type payload is of variable length and will depend on number of channels.
        This payload will have channel types for each of the num_channels. Valid channel types are
